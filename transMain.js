...
function drawShapes() {
  ...
  glMatrix.mat4.scale (modelMatrix,  modelMatrix, [4,0.5,4])
  ...
  //glMatrix.mat4.rotateX (modelMatrix,  modelMatrix, radians(-10.0))
  glMatrix.mat4.scale (modelMatrix,  modelMatrix, [4,0.5,4])
  glMatrix.mat4.translate (modelMatrix,  modelMatrix, [0,-6.94,0])
  // send the model matrix to the shader and draw.
  gl.uniformMatrix4fv (program.uModelT, false, modelMatrix);
  gl.bindVertexArray(myCube.VAO);
  gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);
  ...
  //glMatrix.mat4.rotateX (modelMatrix,  modelMatrix, radians(-10.0))
  // glMatrix.mat4.rotateX (modelMatrix,  modelMatrix, radians(10.0))
  //glMatrix.mat4.scale (modelMatrix,  modelMatrix, [0.5,0,0.5])
  glMatrix.mat4.rotateY (modelMatrix,  modelMatrix, radians(180.0))
  ...
  modelMatrix = glMatrix.mat4.create();
  glMatrix.mat4.rotateX (modelMatrix,  modelMatrix, radians(90.0))
  //glMatrix.mat4.rotateY (modelMatrix,  modelMatrix, radians(90.0))
  ...
  modelMatrix = glMatrix.mat4.create();
  glMatrix.mat4.scale (modelMatrix,  modelMatrix, [4,0.5,4])
  glMatrix.mat4.translate (modelMatrix,  modelMatrix, [2,-6.94,0])
  // send the model matrix to the shader and draw.
  gl.uniformMatrix4fv (program.uModelT, false, modelMatrix);
  gl.bindVertexArray(myCube.VAO);
  gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);
